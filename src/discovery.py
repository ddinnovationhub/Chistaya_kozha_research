...
AGGREGATOR_DOMAINS = {
    ...
    "doctu.ru", "like.doctor",   # каталоги врачей (такт 3, итерация 3)
    # мини-сайты каталогов (заказчик, 2026-08-28, пачка 1: 9 строк из 200):
    # конструкторы карточек публикуют ИНН организации в реквизитах, поэтому
