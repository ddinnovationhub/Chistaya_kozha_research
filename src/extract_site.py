...
PROFILE_ANCHOR_RE = re.compile(
    r"дермат|трихо|кож[аеиун]|волос|ногт|родин|невус|папиллом|бородав|кератом"
    ...
    r"|соскоб|дерматофит|онихо|базалиом|меланом|пигмент",
    re.IGNORECASE)
